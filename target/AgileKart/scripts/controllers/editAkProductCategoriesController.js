...
angular.module('agileKart').controller('EditAkProductCategoriesController', function($scope, $routeParams, $location, AkProductCategoriesResource , AkProductsResource) {
    var self = this;
