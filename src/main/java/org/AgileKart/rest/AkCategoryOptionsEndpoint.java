...
import org.AgileKart.model.AkCategoryOptions;
...
public class AkCategoryOptionsEndpoint
{
   ...
   {
      TypedQuery<AkCategoryOptions> findByIdQuery = em.createQuery("SELECT DISTINCT a FROM AkCategoryOptions a WHERE a.categoryOptionId = :entityId ORDER BY a.categoryOptionId", AkCategoryOptions.class);
   ...
   {
      TypedQuery<AkCategoryOptions> findAllQuery = em.createQuery("SELECT DISTINCT a FROM AkCategoryOptions a ORDER BY a.categoryOptionId", AkCategoryOptions.class);
