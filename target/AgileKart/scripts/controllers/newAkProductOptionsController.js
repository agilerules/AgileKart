...
angular.module('agileKart').controller('NewAkProductOptionsController', function ($scope, $location, locationParser, AkProductOptionsResource , AkOptionGroupsResource, AkOptionsResource, AkProductsResource) {
