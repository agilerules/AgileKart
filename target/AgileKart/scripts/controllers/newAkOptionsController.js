...
angular.module('agileKart').controller('NewAkOptionsController', function ($scope, $location, locationParser, AkOptionsResource , AkOptionGroupsResource, AkProductOptionsResource) {
