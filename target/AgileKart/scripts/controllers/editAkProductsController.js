...
angular.module('agileKart').controller('EditAkProductsController', function($scope, $routeParams, $location, AkProductsResource , AkProductCategoriesResource, AkOrderDetailsResource, AkProductOptionsResource) {
    var self = this;
