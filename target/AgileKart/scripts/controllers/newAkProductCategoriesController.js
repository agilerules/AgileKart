...
angular.module('agileKart').controller('NewAkProductCategoriesController', function ($scope, $location, locationParser, AkProductCategoriesResource , AkProductsResource) {
