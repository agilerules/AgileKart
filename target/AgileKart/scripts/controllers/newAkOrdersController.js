...
angular.module('agileKart').controller('NewAkOrdersController', function ($scope, $location, locationParser, AkOrdersResource , AkUsersResource, AkOrderDetailsResource) {
