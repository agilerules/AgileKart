...
angular.module('agileKart').controller('EditAkOrderDetailsController', function($scope, $routeParams, $location, AkOrderDetailsResource , AkOrdersResource, AkProductsResource) {
    var self = this;
