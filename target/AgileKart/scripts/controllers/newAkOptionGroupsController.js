...
angular.module('agileKart').controller('NewAkOptionGroupsController', function ($scope, $location, locationParser, AkOptionGroupsResource , AkProductOptionsResource, AkOptionsResource) {
