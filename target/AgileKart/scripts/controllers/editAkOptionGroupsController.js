...
angular.module('agileKart').controller('EditAkOptionGroupsController', function($scope, $routeParams, $location, AkOptionGroupsResource , AkProductOptionsResource, AkOptionsResource) {
    var self = this;
