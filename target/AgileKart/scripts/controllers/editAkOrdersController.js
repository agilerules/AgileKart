...
angular.module('agileKart').controller('EditAkOrdersController', function($scope, $routeParams, $location, AkOrdersResource , AkUsersResource, AkOrderDetailsResource) {
    var self = this;
