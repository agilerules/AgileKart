...
angular.module('agileKart').controller('NewAkProductsController', function ($scope, $location, locationParser, AkProductsResource , AkProductCategoriesResource, AkOrderDetailsResource, AkProductOptionsResource) {
