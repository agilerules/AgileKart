...
angular.module('agileKart').controller('NewAkOrderDetailsController', function ($scope, $location, locationParser, AkOrderDetailsResource , AkOrdersResource, AkProductsResource) {
