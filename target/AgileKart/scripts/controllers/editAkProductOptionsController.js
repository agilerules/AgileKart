...
angular.module('agileKart').controller('EditAkProductOptionsController', function($scope, $routeParams, $location, AkProductOptionsResource , AkOptionGroupsResource, AkOptionsResource, AkProductsResource) {
    var self = this;
