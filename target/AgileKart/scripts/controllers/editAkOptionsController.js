...
angular.module('agileKart').controller('EditAkOptionsController', function($scope, $routeParams, $location, AkOptionsResource , AkOptionGroupsResource, AkProductOptionsResource) {
    var self = this;
